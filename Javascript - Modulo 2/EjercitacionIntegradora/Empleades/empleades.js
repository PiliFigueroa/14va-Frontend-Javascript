...
const empleadesQueHacenGuardia = empleades.filter(empleade => empleade.haceGuardia)
const empleadesQueHacenGuardia2 = empleades.filter(({ haceGuardia }) => haceGuardia)

const empleadesQueHacenGuardia3 = empleades.filter(empleade => {
  const { haceGuardia } = empleade
  return haceGuardia
})
...
const filtrarEmpleades = (valor, propiedad) => {
  return empleades.filter(empleade => empleade[propiedad] === valor)
}
